...
namespace MVCPlayWithMe.Models
{
    ...
    {
        public static async Task<List<Publisher>> GetListPublisherConnectOutAsync(MySqlConnection conn)
        {
        ...
        public static async Task<Publisher> GetPublisherAsync(int id)
        {
        ...
        public static async Task<MySqlResultState> CreateNewPublisherAsync(string name, float discount, string detail)
        {
        ...
        public static async Task<MySqlResultState> DeletePublisherAsync(int id)
        {
        ...
        public static async Task<MySqlResultState> UpdatePublisherAsync(int id, string name, float discount, string detail)
        {
        ...
        public static async Task<int> GetPublisherIdFromNameAsync(string name)
        {
            MySqlParameter[] paras = new MySqlParameter[3];
            paras[0] = new MySqlParameter("@publisherName", name);
            MyMySql.AddOutParameters(paras);
